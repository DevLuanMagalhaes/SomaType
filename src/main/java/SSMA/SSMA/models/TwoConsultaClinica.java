...
@SequenceGenerator(name="seqConsultaClinicaId", sequenceName="TWO_CONSULTA_CLINICA_S", allocationSize=1)
public class TwoConsultaClinica implements TwoEntity{
  ...
  */
    ...
    @ManyToMany(cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = FetchType.LAZY) //eager aqui
    @JoinTable(name = "TWO_CONS_CLIN_IMPR_DIAGN",
            joinColumns = { @JoinColumn(name="CONSULTA_CLINICA_ID", referencedColumnName="CONSULTA_CLINICA_ID")},
